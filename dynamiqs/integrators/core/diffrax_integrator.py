...
from .interfaces import AbstractTimeInterface, MEInterface, FPMEInterface, MRMEInterface, SEInterface, SolveInterface
...
class MRMEDiffraxIntegrator(DiffraxIntegrator, MRMEInterface):
    """Integrator solving the Fokker-Planck Lindblad master equation with Diffrax."""
...
class MRMESolveDiffraxIntegrator(MRMEDiffraxIntegrator, SolveSaveMixin, SolveInterface):
    """Integrator computing the time evolution of the Lindblad master equation using the
    Diffrax library.
    """

MRMEsolve_euler_integrator_constructor = partial(
    MRMESolveDiffraxIntegrator, diffrax_solver=dx.Euler(), fixed_step=True
)
MRMEsolve_dopri5_integrator_constructor = partial(
    MRMESolveDiffraxIntegrator, diffrax_solver=dx.Dopri5(), fixed_step=False
)
MRMEsolve_dopri8_integrator_constructor = partial(
    MRMESolveDiffraxIntegrator, diffrax_solver=dx.Dopri8(), fixed_step=False
)
MRMEsolve_tsit5_integrator_constructor = partial(
    MRMESolveDiffraxIntegrator, diffrax_solver=dx.Tsit5(), fixed_step=False
)
MRMEsolve_kvaerno3_integrator_constructor = partial(
    MRMESolveDiffraxIntegrator, diffrax_solver=dx.Kvaerno3(), fixed_step=False
)
MRMEsolve_kvaerno5_integrator_constructor = partial(
    MRMESolveDiffraxIntegrator, diffrax_solver=dx.Kvaerno5(), fixed_step=False
)
